...
pub mod BLSUtils {
    ...
    impl BLSUtilsCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] =
            &[[94u8, 234u8, 120u8, 125u8], [191u8, 71u8, 66u8, 166u8]];
        /// The names of the variants in the same order as `SELECTORS`.
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ::core::stringify!(_toLittleEndian),
        ...
        fn abi_decode_raw_validate(
            ...
            static DECODE_VALIDATE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<BLSUtilsCalls>] =
                &[
                    {
                        fn _toLittleEndian(data: &[u8]) -> alloy_sol_types::Result<BLSUtilsCalls> {
                            <_toLittleEndianCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(BLSUtilsCalls::_toLittleEndian)
                        }
    ...
    impl<P, N> ::core::fmt::Debug for BLSUtilsInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("BLSUtilsInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        BLSUtilsInstance<P, N>
    {
        ...
        pub fn _toLittleEndian(
            &self,
            x: u64,
        ) -> alloy_contract::SolCallBuilder<&P, _toLittleEndianCall, N> {
