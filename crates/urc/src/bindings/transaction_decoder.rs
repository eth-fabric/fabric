...
pub mod TransactionDecoder {
        ...
        fn abi_encoded_size(&self) -> usize {
            match self {
                ...
                Self::InvalidYParity(inner) => {
                    <InvalidYParity as alloy_sol_types::SolError>::abi_encoded_size(inner)
                }
    ...
    impl<P, N> ::core::fmt::Debug for TransactionDecoderInstance<P, N> {
        ...
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("TransactionDecoderInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        TransactionDecoderInstance<P, N>
    {
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<TransactionDecoderInstance<P, N>> {
