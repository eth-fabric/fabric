...
pub mod PreconfStructs {
    ...
    impl<P, N> ::core::fmt::Debug for PreconfStructsInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("PreconfStructsInstance")
                .field(&self.address)
                .finish()
        }
    }
...
pub mod InclusionPreconfSlasher {
    ...
    const _: () = {
        ...
        impl proveChallengeFraudulentReturn {
            fn _tokenize(
                &self,
            ) -> <proveChallengeFraudulentCall as alloy_sol_types::SolCall>::ReturnToken<'_>
            {
                ()
            }
        }
    ...
    impl alloy_sol_types::SolInterface for InclusionPreconfSlasherCalls {
        ...
        fn abi_decode_raw_validate(
            ...
            static DECODE_VALIDATE_SHIMS: &[fn(
                ...
                InclusionPreconfSlasherCalls,
            >] = &[
                {
                    fn _getCurrentSlot(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<InclusionPreconfSlasherCalls> {
                        <_getCurrentSlotCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                            data,
                        )
                        .map(InclusionPreconfSlasherCalls::_getCurrentSlot)
                    }
                ...
                },
                {
                    fn SLASH_AMOUNT_WEI(
                        ...
                        <SLASH_AMOUNT_WEICall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                            data,
                        )
                        .map(InclusionPreconfSlasherCalls::SLASH_AMOUNT_WEI)
                    }
                ...
                },
                {
                    fn _decodeBlockHeaderRLP(
                        ...
                        <_decodeBlockHeaderRLPCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(InclusionPreconfSlasherCalls::_decodeBlockHeaderRLP)
                    }
                ...
                },
                {
                    fn proveChallengeFraudulent(
                        ...
                        <proveChallengeFraudulentCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(InclusionPreconfSlasherCalls::proveChallengeFraudulent)
                    }
                ...
                },
                {
                    fn JUSTIFICATION_DELAY(
                        ...
                        <JUSTIFICATION_DELAYCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(InclusionPreconfSlasherCalls::JUSTIFICATION_DELAY)
                    }
                ...
                },
                {
                    fn BEACON_ROOTS_CONTRACT(
                        ...
                        <BEACON_ROOTS_CONTRACTCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(InclusionPreconfSlasherCalls::BEACON_ROOTS_CONTRACT)
                    }
                ...
                },
                {
                    fn CHALLENGE_BOND(
                        ...
                        <CHALLENGE_BONDCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                            data,
                        )
                        .map(InclusionPreconfSlasherCalls::CHALLENGE_BOND)
                    }
                ...
                },
                {
                    fn ETH2_GENESIS_TIMESTAMP(
                        ...
                        <ETH2_GENESIS_TIMESTAMPCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(InclusionPreconfSlasherCalls::ETH2_GENESIS_TIMESTAMP)
                    }
                ...
                },
                {
                    fn _getSlotFromTimestamp(
                        ...
                        <_getSlotFromTimestampCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(InclusionPreconfSlasherCalls::_getSlotFromTimestamp)
                    }
                ...
                },
                {
                    fn EIP4788_WINDOW(
                        ...
                        <EIP4788_WINDOWCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                            data,
                        )
                        .map(InclusionPreconfSlasherCalls::EIP4788_WINDOW)
                    }
                ...
                },
                {
                    fn BLOCKHASH_EVM_LOOKBACK(
                        ...
                        <BLOCKHASH_EVM_LOOKBACKCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(InclusionPreconfSlasherCalls::BLOCKHASH_EVM_LOOKBACK)
                    }
                ...
                },
                {
                    fn _getTimestampFromSlot(
                        ...
                        <_getTimestampFromSlotCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(InclusionPreconfSlasherCalls::_getTimestampFromSlot)
                    }
        ...
        fn abi_encode_raw(&self, out: &mut alloy_sol_types::private::Vec<u8>) {
            match self {
                ...
                Self::SLOT_TIME(inner) => {
                    <SLOT_TIMECall as alloy_sol_types::SolCall>::abi_encode_raw(inner, out)
                }
                Self::_decodeBlockHeaderRLP(inner) => {
                ...
                Self::challenges(inner) => {
                    <challengesCall as alloy_sol_types::SolCall>::abi_encode_raw(inner, out)
                }
                Self::createChallenge(inner) => {
    ...
    impl alloy_sol_types::SolInterface for InclusionPreconfSlasherErrors {
            ...
            >] = &[
                {
                    ...
                    {
                        <ChallengeDoesNotExist as alloy_sol_types::SolError>::abi_decode_raw_validate(
                                data,
                            )
                            .map(InclusionPreconfSlasherErrors::ChallengeDoesNotExist)
                    }
                ...
                },
                {
                    ...
                    {
                        <TransactionExcluded as alloy_sol_types::SolError>::abi_decode_raw_validate(
                            data,
                        )
                        .map(InclusionPreconfSlasherErrors::TransactionExcluded)
                    }
                ...
                },
                {
                    ...
                    {
                        <FraudProofWindowActive as alloy_sol_types::SolError>::abi_decode_raw_validate(
                                data,
                            )
                            .map(InclusionPreconfSlasherErrors::FraudProofWindowActive)
                    }
                ...
                },
                {
                    ...
                    {
                        <DelegationExpired as alloy_sol_types::SolError>::abi_decode_raw_validate(
                            data,
                        )
                        .map(InclusionPreconfSlasherErrors::DelegationExpired)
                    }
                ...
                },
                {
                    ...
                    {
                        <InvalidBlockHash as alloy_sol_types::SolError>::abi_decode_raw_validate(
                            data,
                        )
                        .map(InclusionPreconfSlasherErrors::InvalidBlockHash)
                    }
                ...
                },
                {
                    ...
                    {
                        <InvalidParentBlockHash as alloy_sol_types::SolError>::abi_decode_raw_validate(
                                data,
                            )
                            .map(InclusionPreconfSlasherErrors::InvalidParentBlockHash)
                    }
                ...
                },
                {
                    ...
                    {
                        <ChallengeAlreadyExists as alloy_sol_types::SolError>::abi_decode_raw_validate(
                                data,
                            )
                            .map(InclusionPreconfSlasherErrors::ChallengeAlreadyExists)
                    }
                ...
                },
                {
                    ...
                    {
                        <WrongChallengerAddress as alloy_sol_types::SolError>::abi_decode_raw_validate(
                                data,
                            )
                            .map(InclusionPreconfSlasherErrors::WrongChallengerAddress)
                    }
                ...
                },
                {
                    ...
                    {
                        <WrongTransactionHashProof as alloy_sol_types::SolError>::abi_decode_raw_validate(
                                data,
                            )
                            .map(
                ...
                },
                {
                    ...
                    {
                        <IncorrectChallengeBond as alloy_sol_types::SolError>::abi_decode_raw_validate(
                                data,
                            )
                            .map(InclusionPreconfSlasherErrors::IncorrectChallengeBond)
                    }
                ...
                },
                {
                    ...
                    {
                        <UnexpectedSigner as alloy_sol_types::SolError>::abi_decode_raw_validate(
                            data,
                        )
                        .map(InclusionPreconfSlasherErrors::UnexpectedSigner)
                    }
                ...
                },
                {
                    ...
                    {
                        <BlockIsNotFinalized as alloy_sol_types::SolError>::abi_decode_raw_validate(
                            data,
                        )
                        .map(InclusionPreconfSlasherErrors::BlockIsNotFinalized)
                    }
                ...
                },
                {
                    ...
                    {
                        <InvalidFieldCount as alloy_sol_types::SolError>::abi_decode_raw_validate(
                            data,
                        )
                        .map(InclusionPreconfSlasherErrors::InvalidFieldCount)
                    }
                ...
                },
                {
                    ...
                    {
                        <UnsupportedTxType as alloy_sol_types::SolError>::abi_decode_raw_validate(
                            data,
                        )
                        .map(InclusionPreconfSlasherErrors::UnsupportedTxType)
                    }
                ...
                },
                {
                    ...
                    {
                        <BeaconRootNotFound as alloy_sol_types::SolError>::abi_decode_raw_validate(
                            data,
                        )
                        .map(InclusionPreconfSlasherErrors::BeaconRootNotFound)
                    }
        ...
        fn abi_encode_raw(&self, out: &mut alloy_sol_types::private::Vec<u8>) {
            match self {
                ...
                Self::BlockIsTooOld(inner) => {
                    <BlockIsTooOld as alloy_sol_types::SolError>::abi_encode_raw(inner, out)
                }
                Self::ChallengeAlreadyExists(inner) => {
                ...
                Self::NoSignature(inner) => {
                    <NoSignature as alloy_sol_types::SolError>::abi_encode_raw(inner, out)
                }
                Self::NotURC(inner) => {
    ...
    pub fn deploy<P: alloy_contract::private::Provider<N>, N: alloy_contract::private::Network>(
        ...
        Output = alloy_contract::Result<InclusionPreconfSlasherInstance<P, N>>,
    > {
        ...
        InclusionPreconfSlasherInstance<P, N>
    {
        ...
        pub fn BEACON_ROOTS_CONTRACT(
            &self,
        ) -> alloy_contract::SolCallBuilder<&P, BEACON_ROOTS_CONTRACTCall, N> {
        ...
        pub fn BLOCKHASH_EVM_LOOKBACK(
            &self,
        ) -> alloy_contract::SolCallBuilder<&P, BLOCKHASH_EVM_LOOKBACKCall, N> {
        ...
        pub fn ETH2_GENESIS_TIMESTAMP(
            &self,
        ) -> alloy_contract::SolCallBuilder<&P, ETH2_GENESIS_TIMESTAMPCall, N> {
        ...
        pub fn JUSTIFICATION_DELAY(
            &self,
        ) -> alloy_contract::SolCallBuilder<&P, JUSTIFICATION_DELAYCall, N> {
        ...
        pub fn SLASH_AMOUNT_WEI(
            &self,
        ) -> alloy_contract::SolCallBuilder<&P, SLASH_AMOUNT_WEICall, N> {
        ...
        pub fn _getCurrentSlot(
            &self,
        ) -> alloy_contract::SolCallBuilder<&P, _getCurrentSlotCall, N> {
        ...
        pub fn createChallenge(
            ...
            self.call_builder(&createChallengeCall {
                commitment,
                signedDelegation,
            })
        }
        ...
        pub fn proveChallengeFraudulent(
            ...
            self.call_builder(&proveChallengeFraudulentCall {
                delegation,
                commitment,
                proof,
            })
