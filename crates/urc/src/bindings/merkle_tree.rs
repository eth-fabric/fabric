...
pub mod MerkleTree {
    ...
    impl alloy_sol_types::SolInterface for MerkleTreeErrors {
        ...
        fn abi_encoded_size(&self) -> usize {
            match self {
                ...
                Self::LeavesTooLarge(inner) => {
                    <LeavesTooLarge as alloy_sol_types::SolError>::abi_encoded_size(inner)
                }
            }
        }
        #[inline]
        fn abi_encode_raw(&self, out: &mut alloy_sol_types::private::Vec<u8>) {
            match self {
                Self::EmptyLeaves(inner) => {
                    <EmptyLeaves as alloy_sol_types::SolError>::abi_encode_raw(inner, out)
                }
                Self::IndexOutOfBounds(inner) => {
    ...
    impl<P, N> ::core::fmt::Debug for MerkleTreeInstance<P, N> {
        ...
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("MerkleTreeInstance")
                .field(&self.address)
                .finish()
        }
    }
